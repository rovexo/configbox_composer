...
class ConfigboxModelAdminxrefelementoptions extends KenedoModel {
	...
	function getPropertyDefinitions() {
		...
		$propDefs['option_picker_image'] = array(
			...
			'size'=>'1000',
			'dirBase'=>CONFIGBOX_DIR_ANSWER_PICKER_IMAGES,
			'urlBase'=>CONFIGBOX_URL_ANSWER_PICKER_IMAGES,
			'required'=>0,
		...
		$propDefs['visualization_image'] = array(
			...
			'allow'=>array('image/pjpeg','image/jpg','image/jpeg','image/gif','image/tif','image/bmp','image/png'),
			'size'=>'1000',
			'dirBase'=>CONFIGBOX_DIR_VIS_ANSWER_IMAGES,
			'urlBase'=>CONFIGBOX_URL_VIS_ANSWER_IMAGES,
			'required'=>0,
