...
a(document).on("cbFormTaskResponseReceivedGlobal",function(b,d,f){try{var k=JSON.parse(d.responseText)}catch(m){console.warn('Could not parse JSON response. Response text was: "'+d.responseText+'"');console.warn("Error message follows:");console.warn(m);return}if(!0===k.success){var h;b=k.data.id;d=f.viewName.replace("admin","");var l=!1;"adminproduct"===f.viewName&&(b=h=k.data.id,l=k.wasInsert);"adminpage"===f.viewName&&(h=k.data.product_id);"adminelement"===f.viewName&&(f=k.data.page_id,h=a(".view-adminproducttree").find("#page-"+
f).closest(".product-item").attr("id").replace("product-",""));g.refreshProductTree(b,d,h,l)}})},initProductTreeEach:function(){a("#product_tree_list_id").chosen();g.makeTreeSortable()},makeTreeSortable:function(){var b={placeholder:"ui-state-highlight",items:">li:not(.add-item)",update:function(){var d=a(this),f=d.sortable("toArray");d.sortable("disable");var k="",h="";d.is(".page-list")&&(k="adminpages",h="page-");d.is(".question-list")&&(k="adminelements",h="question-");d.is(".answer-list")&&(k=
"adminoptionassignments",h="answer-");var l=10,m={},n;for(n in f)if(f.hasOwnProperty(n)&&-1!==f[n].indexOf(h)){var p=f[n].replace(h,"");m[p]=l;l+=10}f={updates:JSON.stringify(m)};c.makeRequest(k,"storeOrdering",f).done(function(){d.sortable("enable")})}};a(".sub-list-trigger.product-title").one("click",function(){var d=a(this).closest("li").find(".page-list");window.setTimeout(function(){d.sortable(b).disableSelection()},100)});a(".sub-list-trigger.configurator-page-title").one("click",function(){var d=
a(this).closest("li").find(".question-list");window.setTimeout(function(){d.sortable(b).disableSelection()},100)});a(".view-adminproducttree .list-opened").sortable(b).disableSelection()},refreshProductTree:function(b,d,f,k){if(0!==a(".view-adminproducttree").length){var h=a(".view-adminproducttree .product-list").data("update-url"),l=encodeURIComponent(JSON.stringify(this.getOpenProductTreeBranchIds()));"magento"===c.config.platformName?h+="open_branch_ids/"+l+"/only_product_id/"+f:(h+=-1===h.indexOf("?")?
"?":"&",h+="open_branch_ids="+l+"&only_product_id="+f);k&&a(".view-adminproducttree .product-list .product-item.add-item").before('<li class="product-item" id="product-'+f+'"></li>');a("#product-"+f).load(h+" #product-"+f+">div",function(){a(".view-adminproducttree .active").removeClass("active");"element"===d&&(d="question");a("#"+d+"-"+b).addClass("active");g.makeTreeSortable()})}},getOpenProductTreeBranchIds:function(){var b={products:[],pages:[],questions:[]};a(".sub-list-trigger").each(function(d,
