...
e).addClass("uses-dropdown-instead");a.each(b,function(a,b){c.append('<option value="'+b.id+'">'+b.city_name+"</option>")});c.trigger("change").trigger("chosen:updated")}})})})},getCustomerFormData:function(){var b={};a(".kenedo-view.view-customerform :input").each(function(d,c){a(c).attr("name")&&(a(c).is("input[type=radio]")&&!0===a(c).prop("checked")?b[a(c).attr("name")]=a(c).val():a(c).is("input[type=checkbox]")?b[a(c).attr("name")]=!0===a(c).prop("checked")?"1":"0":b[a(c).attr("name")]=a(c).val())});
"1"===b.samedelivery&&a.each(b,function(a,c){0===a.indexOf("billing")&&(a=a.substr(7),"undefined"!==typeof b[a]&&(b[a]=c))});return b},displayValidationIssues:function(b){a(".view-customerform .customer-field:visible").removeClass("invalid").addClass("valid");for(var d in b)b.hasOwnProperty(d)&&(a(".customer-field-"+b[d].fieldName).removeClass("valid").addClass("invalid"),a(".customer-field-"+b[d].fieldName).find(".validation-tooltip").data("content",b[d].message));e.initValidationTooltips()},removeValidationIssues:function(){a(".view-customerform .customer-field:visible").removeClass("invalid").removeClass("valid");
a(".view-customerform .validation-tooltip").data("content","");e.initValidationTooltips()},initValidationTooltips:function(){a(".validation-tooltip").each(function(){var b={placement:"undefined"!==typeof a(this).data("placement")?a(this).data("placement"):"top",trigger:"undefined"!==typeof a(this).data("trigger")?a(this).data("trigger"):"hover",delay:"undefined"!==typeof a(this).data("delay")?a(this).data("delay"):200,html:"undefined"!==typeof a(this).data("html")?a(this).data("html"):!0};a(this).popover(b)})}};
return e});
