...
break;case "store":case "apply":case "storeAndNew":cbrequire(["tinyMCE"],function(a){a.triggerSave();a=new XMLHttpRequest;a.onload=function(){b.form.trigger("cbFormTaskResponseReceived",[this,b])};a.open("post",b.form[0].action,!0);a.send(new FormData(b.form[0]))})}},onFormTaskResponseReceived:function(a,e,g){try{var d=JSON.parse(e.responseText)}catch(r){console.warn('Could not parse JSON response. Response text was: "'+e.responseText+'"');console.warn("Error message follows:");console.warn(r);return}g.btn.removeClass("disabled");
switch(g.task){case "store":if(!1===d.success){c.showResponseMessages(g.form,d.errors||[],d.messages||[]);return}0<g.form.closest(".modal").length?g.form.closest(".modal").modal("hide").find(".modal-content").html(""):(a=c.base64UrlDecode(c.getFormParameter(g.form,"return")),c.loadSubview(a,null,function(){var a=b(".kenedo-listing-form:first");c.showResponseMessages(a,d.errors||[],d.messages||[])}));break;case "storeAndNew":c.showResponseMessages(g.form,d.errors||[],d.messages||[]);!0===d.success&&
d.data&&d.data.id&&c.setFormParameter(g.form,"id","");break;case "apply":if(!1===d.success){c.showResponseMessages(g.form,d.errors||[],d.messages||[]);return}!0===d.success&&d.data&&d.data.id&&c.setFormParameter(g.form,"id",d.data.id);c.refreshForm(g.form,function(){g.form=b(".kenedo-details-form:first");c.showResponseMessages(g.form,d.errors||[],d.messages||[])})}b(document).trigger("cbFormTaskResponseReceivedGlobal",[e,g])},showResponseMessages:function(a,e,g){var d=a.find(".kenedo-messages:first");
d.find(".kenedo-messages-error").html("<ul></ul>");d.find(".kenedo-messages-notice").html("<ul></ul>");0!==e.length&&(b.each(e,function(a,b){d.find(".kenedo-messages-error ul").append("<li>"+b+"</li>")}),d.find(".kenedo-messages-error").show(),d.find(".kenedo-messages-error").addClass("flash"),window.setTimeout(function(){d.find(".kenedo-messages-error").removeClass("flash")},1E3));0!==g.length&&(b.each(g,function(a,b){d.find(".kenedo-messages-notice ul").append("<li>"+b+"</li>")}),d.find(".kenedo-messages-notice").show(),
d.find(".kenedo-messages-notice").addClass("flash"),window.setTimeout(function(){d.find(".kenedo-messages-notice").removeClass("flash")},1E3));(0<g.length||0<e.length)&&d.show()},loadSubview:function(a,e,g,d){var c=e?e:".configbox-ajax-target";if("object"==typeof a)var h=a.value;"string"==typeof a&&""!==a&&(h=a);if(!h)throw"loadSubview called, but no URL could be determined.";void 0!==d&&!1!==d||window.history.pushState({isSubview:!0,url:h,targetSelector:c},"",h);-1===h.indexOf("output_mode")&&("magento"===
k.config.platformName||"magento2"===k.config.platformName?h+="output_mode/view_only":(h+=-1===h.indexOf("?")?"?":"&",h+="output_mode=view_only"));cbrequire(["tinyMCE"],function(a){3<a.majorVersion&&a.remove()});b(c).animate({opacity:".0"},200,function(){b(c).load(h+" .kenedo-view:first",function(a,e,d){200!==d.status&&(a='<div id="view-error" class="kenedo-view"><div class="kenedo-listing-form"><p>Encountered a system error: HTTP code is '+(d.status+". Text message is: "+d.statusText+"</p>"),a+="</div></div>",
b(c).html(a));b(c).animate({opacity:"1"},200,function(){b(document).trigger("cbViewInjected");"function"==typeof g&&g(b(c))})})})},onOpenColorBoxModal:function(a){var e=b(this);a.preventDefault();var g=e.data("modal-width"),d=e.data("modal-height"),c=e.attr("href");g||(g=900);d||(d=600);cbrequire(["cbj.colorbox"],function(){b.colorbox({transition:"fade",href:c,overlayClose:!0,iframe:!0,fastIframe:!1,className:"cb-modal",width:g,height:d})})},addedStylesheets:[],addStylesheet:function(a){-1===this.addedStylesheets.indexOf(a.toLowerCase())&&
(this.addedStylesheets.push(a.toLowerCase()),a='<link rel="stylesheet" type="text/css" href="'+a+'">',b("head").append(a))},subviewReadyFunctions:{},base64UrlEncode:function(a){return p.encode(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,",")},base64UrlDecode:function(a){a=a.replace(/-/g,"+").replace(/_/g,"/").replace(/,/g,"=");return p.decode(a)},openDetailsFormModal:function(a,e,g,d,r,h,f){var u=b(".view-admin .configbox-modals");if(0<u.find(".intra-listing-modal").length)var l=u.find(".intra-listing-modal");
else l=b('<div class="modal intra-listing-modal" tabindex="-1" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"></div></div></div>'),l.appendTo(u);l.data("parent-form",e);l.data("parent-intra-listing",a);cbrequire(["cbj","cbj.bootstrap"],function(b){l.one("hide.bs.modal",function(){c.refreshList(a)});b={id:r};h&&(b["prefill_"+h]=f);k.injectHtml(l.find(".modal-content"),g,d,b,function(){l.modal({keyboard:!1,backdrop:"static"})})})},openListingLink:function(a){a.preventDefault();
var e=b(this);if(0<e.closest(".intra-listing").length){a=e.closest(".kenedo-listing-form");var g=e.closest(".kenedo-details-form"),d=e.data("controller"),r=e.data("task");e=e.data("id");var h=c.getListParameter(a,"foreignKeyField"),f=c.getListParameter(a,"foreignKeyPresetValue");c.openDetailsFormModal(a,g,d,r,e,h,f)}else a=b(this).attr("href"),c.loadSubview(a)},setPropertyVisibility:function(a,e,g){var d={},c,h;e||(e={});g.find(".property-group").each(function(){h=b(this).attr("id");h=h.replace("property-name-",
"");e[h]=""});for(var f in e)if(e.hasOwnProperty(f)&&(a=g.find(".property-name-"+f),d=a.data("propertyDefinition"))){var k=!0;if(!a.hasClass("invisible-field")){if(d.appliesWhen)for(c in d.appliesWhen)if(d.appliesWhen.hasOwnProperty(c)){var l=e[c];var m=d.appliesWhen[c];"object"!=typeof m&&(m=[m]);var q=!1;for(var n in m)if(m.hasOwnProperty(n)){var p="is";"string"==typeof m[n]&&"!"===m[n].substr(0,1)&&(m[n]=m[n].substr(1),p="is not");if("is"===p){if("*"===m[n]&&l&&"0"!=l){q=!0;break}if(m[n]==l){q=
!0;break}}else{if("*"===m[n]&&(!l||"0"==l)){q=!0;break}if(m[n]!=l){q=!0;break}}}!1===q&&(k=!1)}k?"none"===a.css("display")&&(a.show(),d="undefined"===typeof d["default"]?"":d["default"])&&(l=a.find(":input[name="+f+"]"),l.is("select")?l.val(d).change().trigger("chosen:updated"):l.is("[type=radio]")?a.find("input[value="+d+"]").prop("checked",!0):l.val(d),l.change(),e[f]=d):"none"!==a.css("display")&&(a.hide(),l=a.find(":input[name="+f+"]"),l.is("select")?(d="undefined"===typeof d["default"]?"0":d["default"],
l.val(d).trigger("chosen:updated")):(l.is("[type=radio]")?(d="undefined"===typeof d["default"]?"0":d["default"],a.find("input[value="+d+"]").prop("checked",!0)):(d="undefined"===typeof d["default"]?"":d["default"],l.val(d)),a.hasClass("property-type-translatable")&&a.find(".form-control").val(d).change()),e[f]=d)}}},onToggleRecordActivation:function(){var a=b(this),e=a.closest(".kenedo-listing-form"),g=a.data("id"),d=a.data("active")?"unpublish":"publish";a.find(".fa").addClass("fa-spinner fa-spin");
c.setListParameter(e,"task",d);c.setListParameter(e,"ids",g);c.refreshList(e)},onListTaskButtonClicked:function(a){var e=b(this),g=e.data("task"),d=e.closest(".kenedo-listing-form"),c=d.data("view");a={btn:e,task:g,list:d,viewName:c,event:a};e.hasClass("disabled")||(e.addClass("disabled"),d.trigger("cbListTaskTriggered",a))},onListTaskTriggered:function(a,b){switch(b.task){case "add":if(!1===0<b.list.closest(".intra-listing").length)a=c.getListParameter(b.list,"add-link"),a=c.base64UrlDecode(a),c.loadSubview(a);
else{a=b.list.closest(".kenedo-details-form");var e=c.getListParameter(b.list,"controller"),d=c.getListParameter(b.list,"foreignKeyField"),f=c.getListParameter(b.list,"foreignKeyPresetValue");c.openDetailsFormModal(b.list,a,e,"edit",0,d,f)}break;case "copy":case "remove":case "delete":a=c.getListParameter(b.list,"controller");e={ids:c.getCheckedListItemIds(b.list).join(",")};k.makeRequest(a,b.task,e).then(function(a,e,d){b.list.trigger("cbListTaskResponseReceived",[d,b])});break;default:console.log('Unknown task "'+
b.task+'"')}},onListTaskResponseReceived:function(a,e,g){g.btn.removeClass("disabled");try{var d=JSON.parse(e.responseText)}catch(r){console.warn('Could not parse JSON response. Response text was: "'+e.responseText+'"');console.warn("Error message follows:");console.warn(r);return}switch(g.task){case "copy":case "remove":c.refreshList(g.list,function(){g.list=b(".kenedo-listing-form:first");c.showResponseMessages(g.list,d.errors||[],d.messages||[])})}b(document).trigger("cbListTaskResponseReceivedGlobal",
