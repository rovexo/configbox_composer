...
e.responseText+'"');console.warn("Error message follows:");console.warn(h);return}g.btn.removeClass("disabled");switch(g.task){case "store":if(!1===d.success){c.showResponseMessages(g.form,d.errors||[],d.messages||[]);return}0<g.form.closest(".modal").length?((a=g.form.closest(".modal").data("parent-intra-listing"))&&c.refreshList(a),g.form.closest(".modal").modal("hide").find(".modal-content").html("")):(a=c.base64UrlDecode(c.getFormParameter(g.form,"return")),c.loadSubview(a,null,function(){var a=
b(".kenedo-listing-form").first();c.showResponseMessages(a,d.errors||[],d.messages||[])}));break;case "storeAndNew":c.showResponseMessages(g.form,d.errors||[],d.messages||[]);!0===d.success&&d.data&&d.data.id&&c.setFormParameter(g.form,"id","");(a=g.form.closest(".modal").data("parent-intra-listing"))&&c.refreshList(a);break;case "apply":if(!1===d.success){c.showResponseMessages(g.form,d.errors||[],d.messages||[]);return}!0===d.success&&d.data&&d.data.id&&c.setFormParameter(g.form,"id",d.data.id);
var r=g.form.closest(".kenedo-view").parent();c.refreshForm(g.form,function(){g.form=r.find(".kenedo-details-form").first();c.showResponseMessages(g.form,d.errors||[],d.messages||[])});(a=g.form.closest(".modal").data("parent-intra-listing"))&&c.refreshList(a)}b(document).trigger("cbFormTaskResponseReceivedGlobal",[e,g])},showResponseMessages:function(a,e,g){var d=a.find(".kenedo-messages").first();d.find(".kenedo-messages-error").html("<ul></ul>");d.find(".kenedo-messages-notice").html("<ul></ul>");
0!==e.length&&(b.each(e,function(a,b){d.find(".kenedo-messages-error ul").append("<li>"+b+"</li>")}),d.find(".kenedo-messages-error").show(),d.find(".kenedo-messages-error").addClass("flash"),window.setTimeout(function(){d.find(".kenedo-messages-error").removeClass("flash")},1E3));0!==g.length&&(b.each(g,function(a,b){d.find(".kenedo-messages-notice ul").append("<li>"+b+"</li>")}),d.find(".kenedo-messages-notice").show(),d.find(".kenedo-messages-notice").addClass("flash"),window.setTimeout(function(){d.find(".kenedo-messages-notice").removeClass("flash")},
1E3));(0<g.length||0<e.length)&&d.show()},loadSubview:function(a,e,g,d){var c=e?e:".configbox-ajax-target";if("object"==typeof a)var h=a.value;"string"==typeof a&&""!==a&&(h=a);if(!h)throw"loadSubview called, but no URL could be determined.";void 0!==d&&!1!==d||window.history.pushState({isSubview:!0,url:h,targetSelector:c},"",h);-1===h.indexOf("output_mode")&&("magento"===k.config.platformName||"magento2"===k.config.platformName?h+="output_mode/view_only":(h+=-1===h.indexOf("?")?"?":"&",h+="output_mode=view_only"));
cbrequire(["tinyMCE"],function(a){3<a.majorVersion&&a.remove()});b(c).animate({opacity:".0"},200,function(){b(c).load(h,function(a,e,d){200!==d.status&&(a='<div id="view-error" class="kenedo-view"><div class="kenedo-listing-form"><p>Encountered a system error: HTTP code is '+(d.status+". Text message is: "+d.statusText+"</p>"),a+="</div></div>",b(c).html(a));b(c).animate({opacity:"1"},200,function(){b(document).trigger("cbViewInjected");"function"==typeof g&&g(b(c))})})})},onOpenColorBoxModal:function(a){var e=
...
base64UrlEncode:function(a){return p.encode(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,",")},base64UrlDecode:function(a){a=a.replace(/-/g,"+").replace(/_/g,"/").replace(/,/g,"=");return p.decode(a)},openDetailsFormModal:function(a,e,g,d,c,h,f){var r=b(".view-admin .configbox-modals");if(0<r.find(".intra-listing-modal").length)var l=r.find(".intra-listing-modal");else l=b('<div class="modal intra-listing-modal" tabindex="-1" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"></div></div></div>'),
l.appendTo(r);l.data("parent-form",e);l.data("parent-intra-listing",a);cbrequire(["cbj","cbj.bootstrap"],function(a){a={id:c};h&&(a["prefill_"+h]=f);k.injectHtml(l.find(".modal-content"),g,d,a,function(){l.modal({keyboard:!1,backdrop:"static"})})})},openListingLink:function(a){a.preventDefault();var e=b(this);if(0<e.closest(".intra-listing").length){a=e.closest(".kenedo-listing-form");var g=e.closest(".kenedo-details-form"),d=e.data("controller"),r=e.data("task");e=e.data("id");var h=c.getListParameter(a,
