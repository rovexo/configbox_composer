...
<?php
$requestUrl = KenedoPlatform::p()->getUrlBase().'/index.php?option=com_configbox&controller=ajaxapi&output_mode=view_only&task=getNotificationUrl&payment_class=worldpay_bg';
