...
/** @var $this ConfigboxViewQuestion_Images */
?>
	...
	<div class="answers">
		...
		<div class="form-group row">
			...
			<?php foreach ($this->question->answers as $answer) { ?>
				...
				<div id="<?php echo hsc($answer->cssId);?>" class="col-6 col-md-4 col-sm-3 <?php echo hsc($answer->cssClasses);?>">

					<label>

						<?php if ($answer->option_picker_image) { ?>
							<span class="configbox-image-button-wrapper">
								<img class="<?php echo $answer->pickerPreloadCssClasses;?>" src="<?php echo $answer->pickerImageSrc;?>" alt="<?php echo hsc($answer->title);?>"<?php echo $answer->pickerPreloadAttributes;?> />
							</span>
						<?php } ?>
