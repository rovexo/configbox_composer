...
<?php if ($this->position) { ?>
	...
	<div <?php echo $this->getViewAttributes();?>>
		<div class="position-details position-product-id-<?php echo intval($this->position->id);?>">
			...
			<div class="position-record">
				...
				<?php if ($this->positionImageSrc) { ?>
					<div class="position-image">
						<img src="<?php echo $this->positionImageSrc;?>"
						     width="<?php echo hsc($this->positionImageWidth);?>"
						     height="<?php echo hsc($this->positionImageHeight);?>"
						     alt="<?php echo hsc($this->position->productTitle);?>" />
					</div>
				<?php } ?>
