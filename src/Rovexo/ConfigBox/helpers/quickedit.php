...
class ConfigboxQuickeditHelper {
	...
	static function getQuestionEditButtons(ConfigboxQuestion $question) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-element">
			...
			<a class="trigger-open-modal" data-modal-width="1040" data-modal-height="700" title="<?php echo KText::_('Edit Question');?>" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminelements&task=edit&id=' . $question->id . '&in_modal=0');?>">
	...
	static function getAnswerEditButtons(ConfigboxAnswer $answer) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-option">
			<a class="quick-edit-button-edit" title="<?php echo KText::_('Delete Answer');?>" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminoptionassignments&task=delete&quickedit=1&tmpl=component&ids=' . $answer->id);?>">
				<i class="fa fa-trash-o" aria-hidden="true"></i>
			</a>			
			<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" title="<?php echo KText::_('Edit Answer');?>" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminoptionassignments&task=edit&in_modal=0&id=' . $answer->id);?>">
				<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
			</a>
		</div>
		<?php
	...
	static function renderConfigurationPageButtons($page, $product = NULL) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-page">
			...
			<div class="page-edit-buttons">
				...
				<div class="toolbarbutton">
					<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminelements&in_modal=0&prefill_page_id='.$page->id.'&task=edit&id=0');?>">
						<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Question');?>
					</a>
					
				</div>
				<div class="toolbarbutton">
					<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminpages&task=edit&id=0&in_modal=0&prefill_product_id='.(int)$page->product_id);?>">
						<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Page');?>
					</a>
				</div>
				<div class="toolbarbutton">
					<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminpages&task=edit&in_modal=0&id='.$page->id);?>">
				...
				<?php if ($product) { ?>
					<div class="toolbarbutton">
						<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminproducts&task=edit&in_modal=0&id='.$product->id);?>">
	...
	static function renderProductPageButtons($product = NULL) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-product-page">
			...
			<div class="toolbarbutton">
				<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminpages&in_modal=0&prefill_prod_id='.$product->id.'&task=edit&id=0');?>">
					<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Page');?>
			 	</a>
			</div>
			
			<div class="toolbarbutton">
				<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminproducts&in_modal=0&task=edit&id='.$product->id);?>">
					<i class="fa fa-pencil-square-o" aria-hidden="true"></i><?php echo KText::_('Edit Product');?>
				</a>
			</div>
	...
	static function renderProductListingButtons($listing) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-product-listing-page">
			<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminproducts&in_modal=0&task=edit&id=0');?>">
				<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Product');?>
			</a>
			<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminlistings&in_modal=0&task=edit&id=0');?>">
				<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Listing');?>
			</a>
			<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminlistings&in_modal=0&id='.$listing->id.'&task=edit');?>">
	...
	static function renderProductButtons($product = NULL) {
		...
		<div class="quick-edit-buttons quick-edit-buttons-product">
			...
			<?php if (!$product->isConfigurable) { ?>
				<a class="trigger-open-modal" data-modal-width="1000" data-modal-height="700" href="<?php echo KLink::getRoute('index.php?option=com_configbox&controller=adminpages&in_modal=0&task=edit&id=0&prefill_product_id='.$product->id);?>">
					<i class="fa fa-plus-square" aria-hidden="true"></i><?php echo KText::_('Add Page');?>
				</a>
			<?php } ?>
